...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary">Danh Mục Thương Hiệu</h4>
        </div>
        <div class="card-body">
            <!-- Control table -->
            <nav class="navbar navbar-expand-sm navbar-light bg-light">
                ...
                <button class="btn btn-danger btn-xs delete-all-brand" id="btnDelete" hidden="" data-url="">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody id="myTable">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <img width="100px" src="{{ asset('/upload/brand/'.$pt['images']) }}">
                            </td>
                            <td align="center">
                                <label>
                                    <a href="editbrand/{{$pt['id']}}">{{$pt['name']}}</a>
                                </label>
                            </td>
                            <td class="text-center">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="editbrand/{{$pt['id']}}" class="dropdown-item mb-0 text-dark">Edit</a></li>
                                </ul>
                            </td>
                        </tr>
                        @endforeach
...
@endsection
@section('title')
    <title>Danh sách thương hiệu điện thoại | Hoàng Phi Mobile</title>
@endsection